...
const { validateRegister, validateLogin, validateForgotPassword, validatePasswordReset } = require('../utils/authValidationRules');
...
// Forgot password
authRouter.post('/forgot', validate(validateForgotPassword),  authController.forgot);

// Reset password
authRouter.post('/reset/:token', validate(validatePasswordReset),  authController.reset);
